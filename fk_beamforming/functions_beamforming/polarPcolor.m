...
if strcmpi(Rscale,'log') && Origin==0
            ...
            if and(thetaMin==0,thetaMax == 360),
                if spokeMesh(kk)<360,
                    ...
                    text(1.08.*contourD(end).*cost(kk),...
                        ...
                        'horiz', 'center', 'vert', 'middle','fontsize',fontsize);
                end
            else
                text(1.08.*contourD(end).*cost(kk),...
                    1.08.*contourD(end).*sint(kk),...
    ...
    function createCircles(rMin,rMax,thetaMin,thetaMax,Ncircles,circlePos,Nspokes)
        ...
        for kk=1:Ncircles
            ...
            t = text(contourD(kk).*cosd(position),...
                ...
                'handlevisibility','off','parent',cax,'color','r','fontweight','bold');
