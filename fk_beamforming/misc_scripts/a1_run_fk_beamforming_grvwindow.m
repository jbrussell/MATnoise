...
save2pdf([figpath,'fk_beamform_',comp{:},'_',num2str(per_min),'_',num2str(per_max),'s_grvwindow_',num2str(min_grv_win),'_',num2str(max_grv_win),'kms.pdf'],1,250);
...
if is_save_mat
    ...
    save([matpath,'fk_beamform_',comp{:},'_',num2str(per_min),'_',num2str(per_max),'s_grvwindow_',num2str(min_grv_win),'_',num2str(max_grv_win),'kms.mat'],'beam');
end
