...
strNAMEcomp = 'ZR';
files = dir([ccf_fullstack_path,'ccf',strNAMEcomp,'/']);
for ii=3:length(files)
    check = dir([ccf_fullstack_path,'ccf',strNAMEcomp,'/',files(ii).name,'/*.mat']);
    if length(check)==0
        rmdir([ccf_fullstack_path,'ccf',strNAMEcomp,'/',files(ii).name])
...
% for ista1=53 % W02 (sediment)
    ...
    list1 = dir([datadir,'/',net1,'/',stacode1,'/*',comp,'Z.sac']);

    for ista2=1:nsta
%     for ista2=90 % W34 (hard rock)
        clear lat1 lat2 lon1 lon2 dist az baz vec_tz2 Z2raw vec_tz Z1raw

        sta2=char(stalist(ista2,:));
        net2=char(netlist(ista2,:));
        toks = strsplit(sta2,'.');
        stacode2 = toks{2};
...
%             file1cH2 = strrep(file1cZ,[comp,'Z'],[comp,'2']);
            ...
            test1Z = dir([datadir,'/',net1,'/',stacode1,'/',file1cZ]);
            test1H1 = dir([datadir,'/',net1,'/',stacode1,'/',file1cH1]);
            test1H2 = dir([datadir,'/',net1,'/',stacode1,'/',file1cH2]);
            ...
            Nchar = length(stacode1);
            file2cZ = dir([datadir,'/',net2,'/',stacode2,'/',stacode2,file1cZ(Nchar+1:end)]);
            file2cH1 = dir([datadir,'/',net2,'/',stacode2,'/',stacode2,file1cH1(Nchar+1:end)]);
            file2cH2 = dir([datadir,'/',net2,'/',stacode2,'/',stacode2,file1cH2(Nchar+1:end)]);
            ...
            data1cH1=dir([datadir,'/',net1,'/',stacode1,'/',year,'/',stacode1,'.',hdayid,'.',comp,'N.sac']);
            data1cH2=dir([datadir,'/',net1,'/',stacode1,'/',year,'/',stacode1,'.',hdayid,'.',comp,'E.sac']);
            data1cZ= dir([datadir,'/',net1,'/',stacode1,'/',year,'/',stacode1,'.',hdayid,'.',comp,'Z.sac']);
            data2cH1=dir([datadir,'/',net2,'/',stacode2,'/',year,'/',stacode2,'.',hdayid,'.',comp,'N.sac']);
            data2cH2=dir([datadir,'/',net2,'/',stacode2,'/',year,'/',stacode2,'.',hdayid,'.',comp,'E.sac']);
            data2cZ= dir([datadir,'/',net2,'/',stacode2,'/',year,'/',stacode2,'.',hdayid,'.',comp,'Z.sac']);

            data1cH1 = [datadir,'/',net1,'/',stacode1,'/',year,'/',data1cH1.name];
            data1cH2 = [datadir,'/',net1,'/',stacode1,'/',year,'/',data1cH2.name];
            data1cZ =  [datadir,'/',net1,'/',stacode1,'/',year,'/',data1cZ.name];
            data2cH1 = [datadir,'/',net2,'/',stacode2,'/',year,'/',data2cH1.name];
            data2cH2 = [datadir,'/',net2,'/',stacode2,'/',year,'/',data2cH2.name];
            data2cZ =  [datadir,'/',net2,'/',stacode2,'/',year,'/',data2cZ.name];
