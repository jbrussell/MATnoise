...
datadir = '/users/jrussel2/data/jrussel2/PROJ_OldORCA/TILT_COMP/NOISE/ATaCR/OUT_COMPLIANCE_day/SAC_1Hz_Zcorr_tiltcomp/'
str_corr = '_Zcorr_tiltcomp';
...
ccf_winlength_path = [ccf_path,'window',num2str(winlength),'hr',str_corr,'/'];
